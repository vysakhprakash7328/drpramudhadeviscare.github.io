...
if(isset($_POST["submit"])){ 
    ...
    if(!empty($_FILES["image"]["name"])) { 
        ...
        if(in_array($fileType, $allowTypes)){ 
            ...
            $insert = $db->query("INSERT into images (email,image, uploaded) VALUES ('$user','$imgContent', NOW())"); 
...
alert('Sorry, only JPG, JPEG, PNG, & GIF files are allowed to upload.');window.location='../index.php';</script>";
                     ...
                     echo "<script type='text/javascript'>
alert('Please select an image file to upload');window.location='../index.php';</script>";
 } 
}
