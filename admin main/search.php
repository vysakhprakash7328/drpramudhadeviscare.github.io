...
$con=mysqli_connect("localhost","root","","veterinary") or die("couldn't connect to server".mysqli_connect_error());
$day=$_POST['search'];
$q="select * from clientdetails where date='$day'";
$search=mysqli_query($con,$q) or die("query failed".mysqli_error($con)); 
?>
...
<?php 
   while($row = mysqli_fetch_array($search, MYSQL_ASSOC)) {
